...
const AboutMe = () => {
    ...
    return (
        <section id="about" className="pt-24 py-12 flex flex-col justify-center items-center shadow-lg shadow-secondary/20 bg-gradient-to-b from-secondary/40 to-primary/50 text-text_dark">
            ...
            <div className="container mx-auto px-6 lg:flex lg:items-center lg:justify-between h-full">
            ...
            <motion.div
                ...
                viewport={{ once: true, amount: 0.2 }} // 'once' pour ne l'animer qu'une seule fois
                transition={{ duration: 0.8 }}
                className="w-full px-4 text-center lg:text-left"
            >
